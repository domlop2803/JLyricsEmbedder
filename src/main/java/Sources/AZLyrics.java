...
public class AZLyrics {
    ...
    private static Lyrics fromURL(String url, String artist, String song) {
        ...
        //basically checks if html contains sry about that msg that all lyrics in azlyrics start with
        //if it contains it, that means it's found lyrics, and takes all the text from that div excluding the warning
        if (matcher.find()) {
